...
class Console:
    ...
    def show(self):
        console_frame = Frame(
            self.controller.view_frame, bg=self.border_color, height=200, highlightthickness=2, highlightcolor=self.bg
        )
        ...
        self.console_log = Text(text_frame, width=some_width, bg=self.bg, fg=self.textcolor)
